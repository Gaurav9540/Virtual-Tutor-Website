<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/admin.Master" AutoEventWireup="true" CodeBehind="viewupdatesubjectcontent.aspx.cs" Inherits="HR_Web_Application.viewupdatesubjectcontent" %>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">View & Update Subject Wise Content</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active">View & Update Subject Wise Content</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="row" style="padding: 20px;" runat="server" id="gridArea" visible="true">
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <asp:GridView ID="GridView1" Width="100%" CellPadding="5" runat="server" AutoGenerateColumns="false"
                                            ...
                                            OnRowUpdating="GridView1_RowUpdating" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="gridview" DataKeyNames="srno">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CODE">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label12" runat="server" Text='<%# Bind("srno") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Description" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbldescritption" runat="server" Text='<%# Bind("decription") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Video Link">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblvideolink" runat="server" Text='<%# Bind("videolink") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <form class="needs-validation">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <asp:Button ID="btnUpdate" runat="server" Visible="false" Text="Update" ValidationGroup="attendance" class="btn btn-sm btn-rounded btn-success" Style="border-radius: 5px !important; padding: 8px; font-size: 17px; font-weight: 800;"
